...
public class JwtTokenGenerator {
    ...
    public JwtTokenGenerator(JwtTokenStorage jwtTokenStorage, JwtProperties jwtProperties) {
        ...
        JwtKeyPairFactory keyPairFactory = new JwtKeyPairFactory();
        this.keyPair =
                keyPairFactory.create(
                        jwtProperties.getKeyLocation(),
    ...
    public JsonNode decodeAndVerify(String jwtToken) {
        ...
        JsonNode jsonObject = JacksonUtils.transferToJsonNode(claims);
        String exp = jsonObject.get(JWT_EXP_KEY).asText();
    ...
    private boolean isExpired(String exp) {
        ...
        return LocalDateTime.now()
                .isAfter(LocalDateTime.parse(exp, DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")));
    }
}
