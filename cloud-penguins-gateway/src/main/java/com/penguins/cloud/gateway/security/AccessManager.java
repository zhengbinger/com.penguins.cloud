...
//
//  private Logger log = LoggerFactory.getLogger(AccessManager.class);
...
//
//  // 权限校验
//  private boolean checkAuthorities(
//      ServerWebExchange exchange, Authentication auth, String requestPath) {
